#############################################################################
# Makefile for building: pesetacoin-qt.app/Contents/MacOS/pesetacoin-qt
# Generated by qmake (2.01a) (Qt 4.8.5) on: Tue Jan 7 10:54:42 2014
# Project:  pesetacoin-qt.pro
# Template: app
# Command: /opt/local/bin/qmake USE_UPNP=- -o Makefile pesetacoin-qt.pro
#############################################################################
...
DIST          = /opt/local/share/qt4/mkspecs/common/unix.conf \
		...
		pesetacoin-qt.pro
QMAKE_TARGET  = pesetacoin-qt
DESTDIR       = 
TARGET        = pesetacoin-qt.app/Contents/MacOS/pesetacoin-qt
...
all: Makefile pesetacoin-qt.app/Contents/PkgInfo pesetacoin-qt.app/Contents/Resources/empty.lproj pesetacoin-qt.app/Contents/Info.plist pesetacoin-qt.app/Contents/Resources/bitcoin.icns $(TARGET)

$(TARGET): /Users/mp2apps/pesetacoin/build/build.h build/ui_sendcoinsdialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_miningpage.h build/ui_optionsdialog.h $(OBJECTS)  
	@$(CHK_DIR_EXISTS) pesetacoin-qt.app/Contents/MacOS/ || $(MKDIR) pesetacoin-qt.app/Contents/MacOS/ 
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: pesetacoin-qt.pro  /opt/local/share/qt4/mkspecs/macx-g++/qmake.conf /opt/local/share/qt4/mkspecs/common/unix.conf \
		/opt/local/share/qt4/mkspecs/common/mac.conf \
		/opt/local/share/qt4/mkspecs/common/gcc-base.conf \
		/opt/local/share/qt4/mkspecs/common/gcc-base-macx.conf \
		/opt/local/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) USE_UPNP=- -o Makefile pesetacoin-qt.pro
...
pesetacoin-qt.app/Contents/PkgInfo: 
	@$(CHK_DIR_EXISTS) pesetacoin-qt.app/Contents || $(MKDIR) pesetacoin-qt.app/Contents 
	@$(DEL_FILE) pesetacoin-qt.app/Contents/PkgInfo
	@echo "APPL????" >pesetacoin-qt.app/Contents/PkgInfo
pesetacoin-qt.app/Contents/Resources/empty.lproj: 
	@$(CHK_DIR_EXISTS) pesetacoin-qt.app/Contents/Resources || $(MKDIR) pesetacoin-qt.app/Contents/Resources 
	@touch pesetacoin-qt.app/Contents/Resources/empty.lproj
	
pesetacoin-qt.app/Contents/Info.plist: 
	@$(CHK_DIR_EXISTS) pesetacoin-qt.app/Contents || $(MKDIR) pesetacoin-qt.app/Contents 
	@$(DEL_FILE) pesetacoin-qt.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,0.6,g" -e "s,@TYPEINFO@,????,g" -e "s,@ICON@,bitcoin.icns,g" -e "s,@EXECUTABLE@,pesetacoin-qt,g" -e "s,@TYPEINFO@,????,g" /opt/local/share/qt4/mkspecs/macx-g++/Info.plist.app >pesetacoin-qt.app/Contents/Info.plist
pesetacoin-qt.app/Contents/Resources/bitcoin.icns: src/qt/res/icons/bitcoin.icns
	@$(CHK_DIR_EXISTS) pesetacoin-qt.app/Contents/Resources/ || $(MKDIR) pesetacoin-qt.app/Contents/Resources/ 
	@$(DEL_FILE) pesetacoin-qt.app/Contents/Resources/bitcoin.icns
	@$(COPY_FILE) src/qt/res/icons/bitcoin.icns pesetacoin-qt.app/Contents/Resources/bitcoin.icns
dist: 
	@$(CHK_DIR_EXISTS) build/pesetacoin-qt0.6.3 || $(MKDIR) build/pesetacoin-qt0.6.3 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/pesetacoin-qt0.6.3/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_bg.ts src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_el_GR.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_pt_PT.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/pesetacoin-qt0.6.3/ && $(COPY_FILE) --parents src/qt/macdockiconhandler.mm build/pesetacoin-qt0.6.3/ && $(COPY_FILE) --parents src/qt/bitcoingui.h src/qt/transactiontablemodel.h src/qt/addresstablemodel.h src/qt/optionsdialog.h src/qt/sendcoinsdialog.h src/qt/addressbookpage.h src/qt/signverifymessagedialog.h src/qt/aboutdialog.h src/qt/editaddressdialog.h src/qt/bitcoinaddressvalidator.h src/addrman.h src/base58.h src/bignum.h src/checkpoints.h src/compat.h src/sync.h src/util.h src/uint256.h src/serialize.h src/strlcpy.h src/main.h src/net.h src/key.h src/db.h src/walletdb.h src/script.h src/init.h src/irc.h src/mruset.h src/json/json_spirit_writer_template.h src/json/json_spirit_writer.h src/json/json_spirit_value.h src/json/json_spirit_utils.h src/json/json_spirit_stream_reader.h src/json/json_spirit_reader_template.h src/json/json_spirit_reader.h src/json/json_spirit_error_position.h src/json/json_spirit.h src/qt/clientmodel.h src/qt/guiutil.h src/qt/transactionrecord.h src/qt/guiconstants.h src/qt/optionsmodel.h src/qt/monitoreddatamapper.h src/qt/transactiondesc.h src/qt/transactiondescdialog.h src/qt/bitcoinamountfield.h src/wallet.h src/keystore.h src/qt/transactionfilterproxy.h src/qt/transactionview.h src/qt/walletmodel.h src/bitcoinrpc.h src/qt/overviewpage.h src/qt/csvmodelwriter.h src/crypter.h src/qt/sendcoinsentry.h src/qt/qvalidatedlineedit.h src/qt/bitcoinunits.h src/qt/qvaluecombobox.h src/qt/askpassphrasedialog.h src/protocol.h src/qt/notificator.h src/qt/qtipcserver.h src/allocators.h src/ui_interface.h src/scrypt.h src/qt/miningpage.h src/version.h src/qt/rpcconsole.h src/qt/macdockiconhandler.h build/pesetacoin-qt0.6.3/ && $(COPY_FILE) --parents src/qt/bitcoin.qrc build/pesetacoin-qt0.6.3/ && $(COPY_FILE) --parents src/qt/bitcoin.cpp src/qt/bitcoingui.cpp src/qt/transactiontablemodel.cpp src/qt/addresstablemodel.cpp src/qt/optionsdialog.cpp src/qt/sendcoinsdialog.cpp src/qt/addressbookpage.cpp src/qt/signverifymessagedialog.cpp src/qt/aboutdialog.cpp src/qt/editaddressdialog.cpp src/qt/bitcoinaddressvalidator.cpp src/version.cpp src/sync.cpp src/util.cpp src/netbase.cpp src/key.cpp src/script.cpp src/main.cpp src/init.cpp src/net.cpp src/irc.cpp src/checkpoints.cpp src/addrman.cpp src/db.cpp src/walletdb.cpp src/json/json_spirit_writer.cpp src/json/json_spirit_value.cpp src/json/json_spirit_reader.cpp src/qt/clientmodel.cpp src/qt/guiutil.cpp src/qt/transactionrecord.cpp src/qt/optionsmodel.cpp src/qt/monitoreddatamapper.cpp src/qt/transactiondesc.cpp src/qt/transactiondescdialog.cpp src/qt/bitcoinstrings.cpp src/qt/bitcoinamountfield.cpp src/wallet.cpp src/keystore.cpp src/qt/transactionfilterproxy.cpp src/qt/transactionview.cpp src/qt/walletmodel.cpp src/bitcoinrpc.cpp src/rpcdump.cpp src/rpcnet.cpp src/rpcrawtransaction.cpp src/qt/overviewpage.cpp src/qt/csvmodelwriter.cpp src/crypter.cpp src/qt/sendcoinsentry.cpp src/qt/qvalidatedlineedit.cpp src/qt/bitcoinunits.cpp src/qt/qvaluecombobox.cpp src/qt/askpassphrasedialog.cpp src/protocol.cpp src/qt/notificator.cpp src/qt/qtipcserver.cpp src/qt/rpcconsole.cpp src/scrypt.c src/qt/miningpage.cpp src/noui.cpp build/pesetacoin-qt0.6.3/ && $(COPY_FILE) --parents src/qt/macdockiconhandler.mm build/pesetacoin-qt0.6.3/ && $(COPY_FILE) --parents src/qt/forms/sendcoinsdialog.ui src/qt/forms/addressbookpage.ui src/qt/forms/signverifymessagedialog.ui src/qt/forms/aboutdialog.ui src/qt/forms/editaddressdialog.ui src/qt/forms/transactiondescdialog.ui src/qt/forms/overviewpage.ui src/qt/forms/sendcoinsentry.ui src/qt/forms/askpassphrasedialog.ui src/qt/forms/rpcconsole.ui src/qt/forms/miningpage.ui src/qt/forms/optionsdialog.ui build/pesetacoin-qt0.6.3/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_bg.ts src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_el_GR.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_pt_PT.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/pesetacoin-qt0.6.3/ && (cd `dirname build/pesetacoin-qt0.6.3` && $(TAR) pesetacoin-qt0.6.3.tar pesetacoin-qt0.6.3 && $(COMPRESS) pesetacoin-qt0.6.3.tar) && $(MOVE) `dirname build/pesetacoin-qt0.6.3`/pesetacoin-qt0.6.3.tar.gz . && $(DEL_FILE) -r build/pesetacoin-qt0.6.3
...
distclean: clean
	-$(DEL_FILE) -r pesetacoin-qt.app
	-$(DEL_FILE) Makefile


/Users/mp2apps/pesetacoin/build/build.h: FORCE
	cd /Users/mp2apps/pesetacoin; /bin/sh share/genbuild.sh /Users/mp2apps/pesetacoin/build/build.h
