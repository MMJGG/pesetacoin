...
int64 static GetBlockValue(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    // Subsidy is cut in half every 525600  blocks, which will occur approximately every 1 year
    nSubsidy >>= (nHeight / 525600); // PesetaCoin: 525k blocks in ~1 year
...
static const int64 nTargetTimespan = 2 * 60 * 60; // PesetaCoin: every 2 hours
static const int64 nTargetSpacing = 60; // PesetaCoin: 1 minutes
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal pesetacoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "PesetaCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x523f8a9f38bb5998df20870d8e306a15e75e60935ee37b66df0fd36584a0e48a");
    }
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // PesetaCoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
